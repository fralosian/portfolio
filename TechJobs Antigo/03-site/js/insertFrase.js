// <<< FUNCÃO AJAX DE INSERÇÃO FRASE >>>
            ...
            $('#btnInsFra').click(function() {
								//captura todos os dados do formulario 'insert-frase' e joga na variavel dados
                var dados = $('#insert-frase').serialize();
